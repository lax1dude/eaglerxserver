...
/**
 * A hash set of <code>int</code>s, implemented using open addressing with
 * linear probing for collision resolution.
 *
 * @see <a href="{@docRoot}/overview-summary.html#interfaces">HPPC interfaces
 *      diagram</a>
 */
public class IntHashSet extends AbstractIntCollection
		implements IntLookupContainer, IntSet, Preallocable, Cloneable, Accountable {

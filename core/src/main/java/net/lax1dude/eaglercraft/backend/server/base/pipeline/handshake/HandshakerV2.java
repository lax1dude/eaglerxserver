...
public class HandshakerV2 implements IHandshaker {

	private final WebSocketInitialInboundHandler inboundHandler;

	public HandshakerV2(WebSocketInitialInboundHandler inboundHandler) {
		this.inboundHandler = inboundHandler;
	}

	public HandshakerV2 init(String eaglerBrand, String eaglerVersionString, int minecraftVersion, boolean auth, byte[] authUsername) {
		return this;
	}

...
import net.lax1dude.eaglercraft.backend.server.api.collect.Accountable;
...
public interface ArraySizingStrategy extends Accountable {
	 ...
	 *                            should comply with the strategy's policies (it is
	 *                            a result of initial rounding or further
	 *                            growCalls). It can also be zero, indicating the
	 *                            growth from an empty buffer.
	 ...
	 * @throws BufferAllocationException If the sizing strategy cannot grow the
	 *                                   buffer (for example due to constraints or
	 *                                   memory limits).
	 */

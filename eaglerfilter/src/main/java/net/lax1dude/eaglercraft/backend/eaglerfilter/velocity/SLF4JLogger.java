...
public class SLF4JLogger implements IEaglerFilterLogger {
	...
	public class SubLogger implements IRewindSubLogger {
		...
		private String name;
		private IEaglerFilterLogger parent;

		public SubLogger(String name, IEaglerFilterLogger parent) {
			this.name = name;
			this.parent = parent;
		}
		...
		@Override
		public IEaglerFilterLogger getParent() {
			return parent;
		}

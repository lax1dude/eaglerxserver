...
public abstract class EaglercraftAuthCookieEvent extends AsyncEvent<IEaglercraftAuthCookieEvent<?, ?>>
		implements IEaglercraftAuthCookieEvent<ProxiedPlayer, BaseComponent> {

	protected EaglercraftAuthCookieEvent(Callback<IEaglercraftAuthCookieEvent<?, ?>> done) {
		super(done);
	}

...
public abstract class EaglercraftAuthPasswordEvent extends AsyncEvent<IEaglercraftAuthPasswordEvent<?, ?>>
		implements IEaglercraftAuthPasswordEvent<ProxiedPlayer, BaseComponent> {

	protected EaglercraftAuthPasswordEvent(Callback<IEaglercraftAuthPasswordEvent<?, ?>> done) {
		super(done);
	}

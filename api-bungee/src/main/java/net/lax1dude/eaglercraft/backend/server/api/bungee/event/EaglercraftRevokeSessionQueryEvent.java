...
public abstract class EaglercraftRevokeSessionQueryEvent extends AsyncEvent<IEaglercraftRevokeSessionQueryEvent<?>>
		implements IEaglercraftRevokeSessionQueryEvent<ProxiedPlayer> {

	protected EaglercraftRevokeSessionQueryEvent(Callback<IEaglercraftRevokeSessionQueryEvent<?>> done) {
		super(done);
	}

...
public class SPacketVCDescription implements EaglerVCPacket {

	public long uuidMost;
	public long uuidLeast;
	public byte[] desc;

	public SPacketVCDescription() {
	}

	public SPacketVCDescription(long uuidMost, long uuidLeast, byte[] desc) {
		this.uuidMost = uuidMost;
		this.uuidLeast = uuidLeast;
		this.desc = desc;
	}

	public SPacketVCDescription(long uuidMost, long uuidLeast, String desc) {
		this.uuidMost = uuidMost;
		this.uuidLeast = uuidLeast;

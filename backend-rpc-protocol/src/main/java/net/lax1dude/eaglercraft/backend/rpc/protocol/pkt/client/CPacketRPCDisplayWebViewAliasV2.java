...
public class CPacketRPCDisplayWebViewAliasV2 implements EaglerBackendRPCPacket {
	...
	public CPacketRPCDisplayWebViewAliasV2() {
	}

	public CPacketRPCDisplayWebViewAliasV2(int flags, String embedTitle, String embedName) {
		this.flags = flags;
	...
	public void readPacket(DataInput buffer) throws IOException {
		...
		embedName = EaglerBackendRPCPacket.readString(buffer, 65535, true, StandardCharsets.US_ASCII);
	}
	...
	public void writePacket(DataOutput buffer) throws IOException {
		...
		EaglerBackendRPCPacket.writeString(buffer, embedName, true, StandardCharsets.US_ASCII);
	}

...
import net.lax1dude.eaglercraft.eaglerxserver.api.notifications.INotificationManager;
import net.lax1dude.eaglercraft.eaglerxserver.api.pause_menu.IPauseMenuManager;
import net.lax1dude.eaglercraft.eaglerxserver.api.skins.IEaglerPlayerCape;
import net.lax1dude.eaglercraft.eaglerxserver.api.skins.IEaglerPlayerSkin;
import net.lax1dude.eaglercraft.eaglerxserver.api.skins.ISkinManagerEagler;
import net.lax1dude.eaglercraft.eaglerxserver.api.voice.IVoiceManager;
